                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-footer-widget">
                                ...
                                <ul className="contact-info">
                                    ...
                                    <li><a href="tel:2242288475">(224) 228-8475</a></li>
                                    <li><a href="mailto:support@ganial.com">support@ganial.com</a></li>
                                    <li><a href="#">www.ganial.com</a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-lg-7 col-md-7">
                                <p><i className="far fa-copyright"></i> 2021 <a href="/">Genial</a>. All Rights Reserved</p>
                            </div>
